...
class BindingEnergyPredictor:
    ...
    DEFAULT_DOWNSTREAM_CHECKPOINT = "./checkpoints/comparison_3feat_partial_charge/downstream/downstream_best_model.pt"
    DEFAULT_GINE_CHECKPOINT = "./checkpoints/comparison_3feat_partial_charge/downstream/gin_e_finetuned.pt"
