...
Ablation study: **atomic_num + tetrahedral_chirality + partial_charge** (`node_feature_dim=3`).
...
Cache: `cache_3feat_partial_charge`
...
Downstream graph cache: `downstream_graph_3feat_partial_charge_cache.pt`
