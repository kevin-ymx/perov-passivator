...
def mol_to_graph(mol: Chem.Mol) -> Data:
    """
    Convert a molecule to a PyTorch Geometric graph (2-feature comparison).
    Node features: [atomic_num, chirality].
    """
    node_features = []
...
class BindingEnergyPredictor:
    ...
    DEFAULT_DOWNSTREAM_CHECKPOINT = "./checkpoints/downstream_2feat/downstream/downstream_best_model.pt"
    DEFAULT_GINE_CHECKPOINT = "./checkpoints/downstream_2feat/downstream/gin_e_finetuned.pt"
