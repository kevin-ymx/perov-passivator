"""
Configuration for 2-feature comparison study (atomic_num + chirality only).
"""
...
class Config:
    ...
    cache_dir: str = "/kfs3/scratch/yeming/ai4m/prediction/dataset/ssl/cache_2feat"
    ...
    # Model parameters
    node_feature_dim: int = 2  # atomic_num, chirality
    ...
    resume_checkpoint: str = "/kfs3/scratch/yeming/ai4m/prediction/comparison_2feat/checkpoints/checkpoint_epoch_145.pt"  # Empty: train from scratch
    ...
    downstream_graph_cache_path: str = "/kfs3/scratch/yeming/ai4m/prediction/cache/downstream_graph_2feat_cache.pt"
    downstream_zero_binding_tags: bool = False  # No binding_tag feature in 2-feat model
