"""
Configuration for 3-feature comparison: atomic_num + tetrahedral_chirality + electronegativity.
"""
...
class Config:
    ...
    cache_dir: str = "/kfs3/scratch/yeming/ai4m/prediction/dataset/ssl/cache_3feat_electronegativity"
    ...
    # Model parameters
    node_feature_dim: int = 3  # atomic_num, chirality, electronegativity
    ...
    resume_checkpoint: str = "/kfs3/scratch/yeming/ai4m/prediction/comparison_3feat_electronegativity/checkpoints/checkpoint_epoch_145.pt"  # Empty: train from scratch
    ...
    downstream_graph_cache_path: str = "/kfs3/scratch/yeming/ai4m/prediction/cache/downstream_graph_3feat_electronegativity_cache.pt"
