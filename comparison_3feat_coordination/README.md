...
Ablation study: **atomic_num + tetrahedral_chirality + coordination_number** (`node_feature_dim=3`).
...
Cache: `cache_3feat_coordination`
...
Downstream graph cache: `downstream_graph_3feat_coordination_cache.pt`
