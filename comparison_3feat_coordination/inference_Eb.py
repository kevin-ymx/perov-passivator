...
def mol_to_graph(mol: Chem.Mol) -> Data:
    """
    Convert a molecule to a PyTorch Geometric graph (3-feature: coordination number).
...
class BindingEnergyPredictor:
    ...
    DEFAULT_DOWNSTREAM_CHECKPOINT = "./checkpoints/comparison_3feat_coordination/downstream/downstream_best_model.pt"
    DEFAULT_GINE_CHECKPOINT = "./checkpoints/comparison_3feat_coordination/downstream/gin_e_finetuned.pt"
